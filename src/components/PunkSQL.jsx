...
const ACHIEVEMENTS = [
  ...
  { id: "all_done", i: "◈", n_en: "SQL Master", n_pt: "SQL Mestre", d_en: "Solve all 100 challenges", d_pt: "Resolva todos os 100 desafios", c: C.cyanHot, check: (s) => s.size >= 100 },
